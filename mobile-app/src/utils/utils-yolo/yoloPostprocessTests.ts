...
function sigmoidTest() {
  ...
  const expected = new Tensor(
    'float32',
    Float32Array.from([0.5, 0.2689414, 0.8807971, 0.0474259]),
    [4],
  )
  if (!assertTensorEquality(actual, expected)) {
...
function addTest() {
  const actual = tensorTransformUtils.add(
    new Tensor('float32', [1, 2, 3]),
    new Tensor('float32', [10, 20, 30]),
  )
...
function subTest() {
  const actual = tensorTransformUtils.sub(
    new Tensor('float32', [1, 2, 3]),
    new Tensor('float32', [10, 20, 30]),
  )
...
function mulTest() {
  const actual = tensorTransformUtils.mul(
    new Tensor('float32', [1, 2, 3]),
    new Tensor('float32', [10, 20, 30]),
  )
...
function divTest() {
  const actual = tensorTransformUtils.div(
    new Tensor('float32', [10, 20, 30]),
    new Tensor('float32', [1, 2, 3]),
  )
...
function softmaxTest() {
  ...
  const expected = new Tensor(
    'float32',
    Float32Array.from([0.0158762, 0.1173104, 0.8668135, 0.0900306, 0.2447284, 0.6652408]),
    [2, 3],
  )
  if (!assertTensorEquality(actual, expected)) {
...
function gatherTest() {
  ...
  const actual = tensorTransformUtils.gather(
    new Tensor('int32', Int32Array.from([1, 2, 3, 4])),
    indices,
  )
...
function sliceTest() {
  const actual = tensorTransformUtils.slice(
    new Tensor('int32', Int32Array.from([1, 2, 3, 4]), [2, 2]),
    [1, 0],
    [1, 2],
  )
...
function tileTest() {
  const actual = tensorTransformUtils.tile(
    new Tensor('int32', Int32Array.from([1, 2, 3, 4]), [2, 2]),
    [1, 2],
  )
...
function reshapeTest() {
  const actual = tensorTransformUtils.reshape(
    new Tensor('int32', Int32Array.from([1, 2, 3, 4])),
    [2, 2],
  )
  const expected = new Tensor('int32', Int32Array.from([1, 2, 3, 4]), [2, 2])
...
function argMax2DTest() {
  const actual = tensorTransformUtils.argMax(
    new Tensor('int32', Int32Array.from([1, 2, 4, 3]), [2, 2]),
    1,
  )
...
function max2DTest() {
  const actual = tensorTransformUtils.max(
    new Tensor('int32', Int32Array.from([1, 2, 3, 4]), [2, 2]),
    1,
  )
